...
# ── Simulate with forecasted demand ─────────────────────────────────────────
...
OUTPUT_FILE = "output_6a_ss_forecasted.json"

output = {
    "status": "EVALUATED",
    "based_on_plan": "output_5a.json",
    "demand_type": "forecasted",
    "safety_stock": {
        "value": SAFETY_STOCK,
        "z": z,
    ...
    "performance": {
        ...
        "total_demand_forecasted":   int(total_demand),
...
plain(ws.cell(1, 2),
      "Assignment 6a - Forecasted demand (with safety stock)",
      bold=True, size=13)
