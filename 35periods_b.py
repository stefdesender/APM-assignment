"""
Assignment 6b (extended horizon, 35 periods)
...
total_new_bo_ceil = math.ceil(total_new_bo)   
...
plain(ws.cell(1, 2),
      "Assignment 6b - Realized demand evaluation (extended horizon, 35 periods)",
      bold=True, size=13)
