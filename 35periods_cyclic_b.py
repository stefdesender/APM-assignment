"""
 Assignment 6b: Realized demand evaluation (35 periods, cyclic repetition)
...
SHEET_NAME  = "Output_cyclic_realdemand"
...
plain(ws.cell(1, 2),
      "Assignment 6a - Extended horizon (35 periods, cyclic repetition) - Realized demand evaluation",
      bold=True, size=13)
