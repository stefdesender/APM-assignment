"""
Assignment 6a: Extended horizon (35 periods, cyclic repetition)
...
import os
from input_data_35periods_cyclic import (
...
if model.status == GRB.OPTIMAL:
    ...
    SHEET_NAME  = "Output_cyclic_forecast"
    ...
    plain(ws.cell(1, 2),
          "Assignment 6a - Extended horizon (35 periods, cyclic repetition) - Forecast evaluation",
          bold=True, size=13)
